...
namespace ARSoft.Tools.Net.Net
{
	...
	public class DaneStream : AuthenticatedStream
	{
		...
		/// </param>
		public void AuthenticateAsClient(string targetHost, int port, ProtocolType protocol = ProtocolType.Tcp, X509CertificateCollection clientCertificates = null, SslProtocols enabledSslProtocols = SslProtocols.Tls, bool checkCertificateRevocation = false)
		{
            ...
            _sslStream.AuthenticateAsClientAsync(targetHost, clientCertificates ?? new X509CertificateCollection(), enabledSslProtocols, checkCertificateRevocation);
        }
		...
		///   checked during authentication.
		/// </param>
		public async Task AuthenticateAsClientAsync(string targetHost, int port, ProtocolType protocol = ProtocolType.Tcp, X509CertificateCollection clientCertificates = null, SslProtocols enabledSslProtocols = SslProtocols.Tls, bool checkCertificateRevocation = false)
		{
