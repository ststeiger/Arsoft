...
namespace ARSoft.Tools.Net.Dns
{
	...
	public class LocRecord : DnsRecordBase
	{
		...
		internal override void ParseRecordData(DomainName origin, string[] stringRepresentation)
		{
			...
			bool latNegative = groups["lat"].Value.Equals("S", StringComparison.OrdinalIgnoreCase);
			Latitude = new Degree(latNegative, groups["latd"].Value, groups["latm"].Value, groups["lats"].Value, groups["latms"].Value);

			bool longNegative = groups["long"].Value.Equals("W", StringComparison.OrdinalIgnoreCase);
